...
public final class Bootstrap {
    ...
    public static void main(String[] ignored) throws Throwable {
        ...
        } else if (ClassLoader.getSystemClassLoader().getClass().getName().equals("org.glavo.janex.bootstrap.loader.ResourceLoader")) {
            try {
                application = (Class<?>) Class.forName("org.glavo.janex.bootstrap.loader.ModuleSupport")
                        .getMethod("mainClass", Class.forName("org.glavo.janex.bootstrap.loader.ResourceLoader"), String.class, String.class)
