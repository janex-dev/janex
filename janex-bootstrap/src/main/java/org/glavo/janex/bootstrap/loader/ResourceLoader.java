...
import org.glavo.janex.bootstrap.fs.JanexFileSystemProvider;
...
public final class ResourceLoader extends URLClassLoader {
    ...
    public ResourceLoader(ClassLoader parent) throws IOException {
        ...
        try {
            ...
            try {
                Class.forName("org.glavo.janex.bootstrap.loader.ModuleSupport").getMethod("initialize", ResourceLoader.class).invoke(null, this);
            ...
            String prefix = "org.glavo.janex.bootstrap.protocol";
