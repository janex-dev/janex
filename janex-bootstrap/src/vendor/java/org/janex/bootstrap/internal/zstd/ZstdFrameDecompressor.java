 ...
 */
// Adapted for Janex; see janex-bootstrap/NOTICE for changes and provenance.
package org.janex.bootstrap.internal.zstd;

import org.janex.bootstrap.internal.zstd.MemoryAccess;
import org.janex.bootstrap.internal.zstd.XxHash64;
...
import static org.janex.bootstrap.internal.zstd.BitInputStream.peekBits;
import static org.janex.bootstrap.internal.zstd.Constants.COMPRESSED_BLOCK;
import static org.janex.bootstrap.internal.zstd.Constants.COMPRESSED_LITERALS_BLOCK;
import static org.janex.bootstrap.internal.zstd.Constants.DEFAULT_MAX_OFFSET_CODE_SYMBOL;
import static org.janex.bootstrap.internal.zstd.Constants.LITERALS_LENGTH_BITS;
import static org.janex.bootstrap.internal.zstd.Constants.LITERAL_LENGTH_TABLE_LOG;
import static org.janex.bootstrap.internal.zstd.Constants.LONG_NUMBER_OF_SEQUENCES;
import static org.janex.bootstrap.internal.zstd.Constants.MAGIC_NUMBER;
import static org.janex.bootstrap.internal.zstd.Constants.MATCH_LENGTH_BITS;
import static org.janex.bootstrap.internal.zstd.Constants.MATCH_LENGTH_TABLE_LOG;
import static org.janex.bootstrap.internal.zstd.Constants.MAX_BLOCK_SIZE;
import static org.janex.bootstrap.internal.zstd.Constants.MAX_LITERALS_LENGTH_SYMBOL;
import static org.janex.bootstrap.internal.zstd.Constants.MAX_MATCH_LENGTH_SYMBOL;
import static org.janex.bootstrap.internal.zstd.Constants.MIN_BLOCK_SIZE;
import static org.janex.bootstrap.internal.zstd.Constants.MIN_SEQUENCES_SIZE;
import static org.janex.bootstrap.internal.zstd.Constants.MIN_WINDOW_LOG;
import static org.janex.bootstrap.internal.zstd.Constants.OFFSET_TABLE_LOG;
import static org.janex.bootstrap.internal.zstd.Constants.RAW_BLOCK;
import static org.janex.bootstrap.internal.zstd.Constants.RAW_LITERALS_BLOCK;
import static org.janex.bootstrap.internal.zstd.Constants.RLE_BLOCK;
import static org.janex.bootstrap.internal.zstd.Constants.RLE_LITERALS_BLOCK;
import static org.janex.bootstrap.internal.zstd.Constants.SEQUENCE_ENCODING_BASIC;
import static org.janex.bootstrap.internal.zstd.Constants.SEQUENCE_ENCODING_COMPRESSED;
import static org.janex.bootstrap.internal.zstd.Constants.SEQUENCE_ENCODING_REPEAT;
import static org.janex.bootstrap.internal.zstd.Constants.SEQUENCE_ENCODING_RLE;
import static org.janex.bootstrap.internal.zstd.Constants.SIZE_OF_BLOCK_HEADER;
import static org.janex.bootstrap.internal.zstd.Constants.SIZE_OF_BYTE;
import static org.janex.bootstrap.internal.zstd.Constants.SIZE_OF_INT;
import static org.janex.bootstrap.internal.zstd.Constants.SIZE_OF_LONG;
import static org.janex.bootstrap.internal.zstd.Constants.SIZE_OF_SHORT;
import static org.janex.bootstrap.internal.zstd.Constants.TREELESS_LITERALS_BLOCK;

import static org.janex.bootstrap.internal.zstd.Util.fail;
import static org.janex.bootstrap.internal.zstd.Util.get24BitLittleEndian;
import static org.janex.bootstrap.internal.zstd.Util.mask;
import static org.janex.bootstrap.internal.zstd.Util.verify;
import static org.janex.bootstrap.internal.zstd.MemoryAccess.ARRAY_BYTE_BASE_OFFSET;
...
public final class ZstdFrameDecompressor {
    ...
    public int decompress(
        ...
        boolean standardFrame = false;

        while (input < inputLimit) {
            if (inputLimit - input >= 8 && (MemoryAccess.getInt(inputBase, input) & 0xfffffff0) == 0x184d2a50) {
                long length = MemoryAccess.getUnsignedInt(inputBase, input + 4);
                verify(length <= inputLimit - input - 8, input, "Truncated skippable frame");
                input += 8 + length;
                continue;
            }
            standardFrame = true;
            ...
            do {
                ...
                verify(blockSize <= MAX_BLOCK_SIZE, input, "Block exceeds maximum size");
                int decodedSize;
                switch (blockType) {
                    case RAW_BLOCK:
                    ...
                    case COMPRESSED_BLOCK:
                        verify(input + blockSize <= inputLimit, input, "Not enough input bytes");
                        decodedSize = decodeCompressedBlock(inputBase, input, blockSize, outputBase, output, outputLimit, frameHeader.windowSize, outputStart);
                        input += blockSize;
                        break;
                    default:
                ...
                verify(decodedSize <= Math.min(MAX_BLOCK_SIZE, frameHeader.windowSize), input, "Decoded block exceeds window");
                output += decodedSize;
            }
            while (!lastBlock);

            verify(frameHeader.contentSize < 0 || output - outputStart == frameHeader.contentSize, input, "Frame content size mismatch");
            if (frameHeader.hasChecksum) {
                verify(input + SIZE_OF_INT <= inputLimit, input, "Truncated checksum");
        ...
        verify(standardFrame, input, "Missing Zstandard frame");
    ...
    int decodeCompressedBlock(
        ...
        return decompressSequences(
                ...
                outputAbsoluteBaseAddress, windowSize);
    }
    ...
    private int decompressSequences(
            ...
            long outputAbsoluteBaseAddress, long windowSize) {
        ...
        if (sequenceCount != 0) {
            ...
            while (sequenceCount > 0) {
                ...
                verify(offset > 0 && offset <= windowSize && matchAddress >= outputAbsoluteBaseAddress, input, "Invalid match offset");
    ...
    static FrameHeader readFrameHeader(final Object inputBase, final long inputAddress, final long inputLimit) {
        ...
        verify((frameHeaderDescriptor & 0x08) == 0, input, "Reserved frame header bit");
        ...
        verify(dictionaryId <= 0, input, "Custom dictionaries not supported");
        ...
        switch (contentSizeDescriptor) {
            ...
            case 3:
                ...
                verify(contentSize >= 0, input, "Frame content size exceeds supported range");
                input += SIZE_OF_LONG;
                break;
        }
