...
import static org.janex.bootstrap.internal.zstd.BitInputStream.isEndOfStream;
import static org.janex.bootstrap.internal.zstd.BitInputStream.peekBitsFast;
...
import static org.janex.bootstrap.internal.zstd.Util.isPowerOf2;
...
class Huffman {
    ...
    // Janex: Huffman tables do not carry across frame boundaries.
    void reset() {
        tableLog = -1;
    }
