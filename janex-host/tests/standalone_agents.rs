...
public class LocalAgent {
    ...
    public static void premain(String option, Instrumentation instrumentation) throws Exception {
        if (!ClassLoader.getSystemClassLoader().getClass().getName().equals("org.glavo.janex.bootstrap.loader.ResourceLoader")) throw new AssertionError("agent ran in parent");
