...
import org.janex.reader.internal.JarArchive;
import org.janex.reader.internal.ModuleRequirement;
import org.janex.reader.internal.codec.ZstandardFrames;
...
public final class JanexReader implements Closeable {
    ...
    private static byte[] decode(byte[] input, int length, byte[] dictionary) throws IOException {
        ...
        try {
            int written = org.janex.reader.internal.codec.zstd.Zstandard.decompress(
