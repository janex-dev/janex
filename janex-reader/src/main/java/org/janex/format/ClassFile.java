...
import static org.janex.format.Input.require;
...
public final class ClassFile {
    ...
    private static final class Parser {
            ...
            for (int index = 1; index < tags.length; index++) {
                ...
                switch (tag) {
                    ...
                    case 18:
                        ...
                        break;
                    case 15:
                        int kind = input.bytes[offsets[index]] & 255;
        ...
        private int bodyU16(int index, int offset) {
            ...
            return (input.bytes[start] & 255) << 8 | input.bytes[start + 1] & 255;
        }
            ...
            for (int index = 0; index < count; index++) {
                ...
                switch (name) {
                    ...
                    case "Code":
                        ...
                        break;
                    default:
                        value.position = value.bytes.length;
                        break;
                }
                value.end();
            }
